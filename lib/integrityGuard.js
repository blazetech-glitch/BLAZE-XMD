...
const BLAZETZ_PATH = path.join(__dirname, "..", "devbmb", "bmbtz.js");
...
function verifyIntegrity(projectRoot) {
    ...
    if (
        ...
        console.error(
            `  devbmb: ${filesWithDevbmb} files / ${totalDevbmb} occurrences (need >= ${MIN_FILES_REFERENCING_DEVBLAZE} files / ${MIN_TOTAL_OCCURRENCES_DEVBLAZE} occurrences)`
        );
        console.error(
